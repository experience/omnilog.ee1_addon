...
require_once PATH_MOD .'omnilog/helpers/EI_number_helper' .EXT;
...
class Omnilog_entry {
  ...
  {
    if ($this->_eemail->valid_email($email))
    {
...
/* File location    : /system/modules/omnilog/classes/omnilog_entry.php */
